...
OBJS= kernel_main.o console.o string.o physicalmemorymanager.o virtualmemorymanager.o vm_pde.o vm_pte.o sysapi.o user.o keyboard.o vgamodes.o vga.o vgaapi.o edge_list.o
